...
# Q=16 -> distribution_center_name (CD de origem da carga)
colunas_base = [4, 10, 15, 16, 23, 24, 27, 31, 42, 43, 47, 48, 49]
...
# repetidas pela identidade da ocorrência (todas as colunas originais selecionadas),
# para não contar a mesma falta duas vezes.
